...
interface DriverDeclinedModalProps {
  visible: boolean;
  onContinue: () => void;
}

export default function DriverDeclinedModal({
  visible,
  onContinue,
}: DriverDeclinedModalProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Message */}
      <Text style={styles.message}>The driver did not accept the trip request.</Text>
